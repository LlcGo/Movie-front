  ...
  <div class="home-box">
    ...
    <el-card>
      <el-table :data="tableData"
        ...
        <el-table-column prop="typeName" label="类型名" width="180"></el-table-column>
...
<!--    新增-->
    ...
    >
      ...
      >
        <el-form-item label="类型名">
          <el-input v-model="formAddLabelAlign.typeName"/>
        </el-form-item>
      </el-form>
      <template #footer>
      <span class="dialog-footer">
...
const getListData = async () => {
  ...
  // return
  const res = await MovieTyepControllerService.listMovieTypeByPageUsingPost(searchForm.value)
...
const handleAddClose = () => {
   formAddLabelAlign.value.typeName = '';
